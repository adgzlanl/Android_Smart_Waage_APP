...
public class SettingsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SSIDSend = (EditText) findViewById(R.id.editText);
        PASSSend = (EditText) findViewById(R.id.editText2);

        btnAccount = (Button) findViewById(R.id.btnSend2);
        EmailSend = (EditText) findViewById(R.id.editText3);
        EPaSSSend = (EditText) findViewById(R.id.editText4);
        EmailSend.setText(email);
        EPaSSSend.setText(password);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                byte[] bytes = ("CON"+SSIDSend.getText().toString()+"|"+PASSSend.getText().toString()+"|").getBytes(Charset.defaultCharset());
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                byte[] bytes = ("ID"+EmailSend.getText().toString()+"|"+EPaSSSend.getText().toString()+"|").getBytes(Charset.defaultCharset());
                mBluetoothConnection.write(bytes);
            }
        });
